...
const SignupForm = () => {
  const [signInWithGoogle, , googleLoading, googleErr] =
    useSignInWithGoogle(auth)
  const [createUserWithEmailAndPassword, , createLoading, createErr] =
    useCreateUserWithEmailAndPassword(auth)

  useEffect(() => {
    if (createErr || googleErr) {
      toast({
        variant: 'destructive',
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="webtech@example.com" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
